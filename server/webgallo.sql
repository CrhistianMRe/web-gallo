...
('Leg Raises', 'Core move: lift straight legs while keeping lower back controlled.', 0,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/raise.png'),

('Ab Crunch Machine', 'Machine-assisted crunch targeting upper abs with controlled range.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/crunch_machine.png'),

('Leg Press', 'Compound leg press focusing quads, glutes, hamstrings; controlled depth.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/lpress.png'),

('Squats', 'Full-body compound lift emphasizing quads, glutes, and core bracing.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/squats.png'),

('Leg Extension', 'Isolation exercise for quadriceps; pause at peak contraction.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/leg_ext.png'),

('Leg Curl', 'Isolation exercise for hamstrings; keep hips stable and control tempo.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/leg_curl.png'),

('Hip Thrust', 'Glute-focused lift; drive hips up and squeeze at the top.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/hip_thrust.png'),

('Calf Raise on Leg Press', 'Calf work using leg press sled; full stretch and full contraction.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/calf_raise.png'),

('Dips', 'Bodyweight push movement targeting chest and triceps; keep shoulders safe.', 0,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/dips.png'),

('Incline Dumbbell Press', 'Incline press emphasizing upper chest; stable shoulder path.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/incline_dumbell_press.png'),

('Overhead Triceps Extension', 'Triceps isolation overhead; elbows fixed, controlled stretch.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/overhead_tricep.png'),

('Triceps Pulldown', 'Cable triceps pressdown; keep elbows tucked and avoid swinging.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/pulldown_tricep.png'),

('Cable Fly', 'Chest isolation using cables; bring hands together with slight elbow bend.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/weight_plate.png'),

('Shoulder Press Machine', 'Machine overhead press for shoulders; steady reps without locking hard.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/shoulder_press_machine.png'),

('Rear Deltoid Machine', 'Rear-delt isolation; focus on pulling with elbows, not hands.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/rear_delt.png'),

('Push-ups', 'Bodyweight push pattern; rigid plank body and full range.', 0,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/push_up.png'),

('Lat Pulldown', 'Vertical pull targeting lats; pull to upper chest with control.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/lat_pulldown.png'),

('Seated Machine Row', 'Horizontal row targeting mid-back; squeeze shoulder blades together.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/machine_row.png'),

('Biceps Curl Machine', 'Biceps isolation with machine support; avoid shoulder swing.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/bicep_curl_machine.png'),

('EZ Bar Curl', 'Free-weight curl using EZ bar; keep elbows fixed and wrists neutral.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/ez_bar_curl.png'),

('EZ Bar Reverse Curl', 'Reverse-grip curl to emphasize forearms and brachialis.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/ez_bar_reverse_curl.png'),

('Shrugs with Barbell', 'Upper-trap work; lift shoulders up, pause, then lower slowly.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/shrugs_barbell.png'),

('Pinch Plates', 'Grip strength drill: pinch weight plates and hold for time.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/weight_plate.png'),

('Wrist Curl Dumbbell seated', 'Forearm flexor isolation; controlled curl without bouncing.', 1,
 'https://raw.githubusercontent.com/CrhistianMRe/web-gallo/feature/express-server/server/resources/weight_plate.png');
